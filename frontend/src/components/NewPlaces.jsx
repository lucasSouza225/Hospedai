...
const NewPlace = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Aqui no futuro você pode enviar os dados para o backend (axios/fetch)
  };
    ...
    <form onSubmit={handleSubmit} className="flex w-full flex-col gap-6 px-8">
      ...
      <div className="flex flex-col gap-1">
        ...
        <input
          ...
          id="title"
          value={title}
          onChange={(e) => setTitle(e.target.value)} // atualiza o state
        />
      </div>
      ...
      <div className="flex flex-col gap-1">
        ...
        {/* Campo para adicionar foto via URL */}
      ...
      <div className="flex flex-col gap-1">
        ...
        {/* Componente separado para selecionar comodidades */}
        <Perks />
      </div>
